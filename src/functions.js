...
export function renderHomeAboutUs() {
    ...
    document.querySelector('container_div').appendChild(home_img_div);
    ...
    document.querySelector('home_img_div').appendChild(home_img);

    // Home Text (div + 3 p's)

    const home_text_div = document.createElement('div');
    home_text_div.classList.add('home_text_div');
    document.querySelector('container_div').appendChild(home_text_div);
    ...
    document.querySelector('home_text_div').appendChild(home_text_1);
    ...
    document.querySelector('home_text_div').appendChild(home_text_2);
    ...
    document.querySelector('home_text_div').appendChild(home_text_3);
}
