...
export const foodSet = [
    ...
    new Food('/images/menu_items/food/mee_goreng.jpeg', 'Mee Goreng', 'Stir-fried noodles or rice noodles (your choice) tossed with vegetables, soy sauce, and spices. This dish is a street food favorite, packed with flavor and perfect for a quick bite.', '6 Rm'),
    new Food('/images/menu_items/food/mee_bandung.jpg', 'Mee Bandung', 'A noodle dish in a rich, flavorful broth made with a mix of spicy and sweet flavors. Served with your choice of noodles, this dish offers a comforting bowl of hearty goodness.', '8 Rm'),
    new Food('/images/menu_items/food/mee_kungfu.jpg', 'Mee Kungfu', 'A crispy noodle dish where the noodles are fried to a crunchy perfection and topped with a thick, savory sauce. The contrasting textures of crispy and saucy make it a popular choice.', '8 Rm'),
